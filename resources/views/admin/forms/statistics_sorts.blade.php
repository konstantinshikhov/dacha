  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Количество сортов секции "Клумба"</span>
        <span class="info-box-number">{{ $klumba_sorts_count }}</span>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="col-md-12">
    <div class="box">
      <div class="box-header with-border text-center">
        <h3 class="box-title">Соотношение сортов по культурам</h3>
      </div>
      <div class="box-body">
        <div class="chart">
          <canvas id="klumba_sorts_chart_bar" width="300" height="75"></canvas>
        </div>
      </div>
    </div>
  </div>
...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Количество сортов секции "Огород"</span>
        <span class="info-box-number">{{ $ogorod_sorts_count }}</span>
      </div>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-md-12">
    <div class="box">
      ...
      <div class="box-body">
        <div class="chart">
          <canvas id="ogorod_sorts_chart_bar" width="300" height="75"></canvas>
        </div>
      </div>
    </div>
  </div>
...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Количество сортов секции "Сад"</span>
        <span class="info-box-number">{{ $sad_sorts_count }}</span>
      </div>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-md-12">
    <div class="box">
      ...
      <div class="box-body">
        <div class="chart">
          <canvas id="sad_sorts_chart_bar" width="300" height="75"></canvas>
        </div>
      </div>
    </div>
  </div>
...
$(document).ready(function() {
  /* Klumba statistics */
  var klumba_sorts_chart_bar_ctx = document.getElementById("klumba_sorts_chart_bar");
  var klumba_sorts_chart_bar_chart;

  klumba_sorts_chart_bar_chart = new Chart(klumba_sorts_chart_bar_ctx, {
    type: 'horizontalBar',
    data: {
      datasets: [{
        data: [@foreach($klumba_sorts_count_cultures as $count){{ $count }},@endforeach],
        backgroundColor: '#a95f8a'
      }],
      labels: [@foreach($klumba_sorts_count_cultures as $culture => $count)'{{ $culture }}',@endforeach]
    },
    options: {
      legend: {
        display: false
  ...
  /* Ogorod statistics */
  var ogorod_sorts_chart_bar_ctx = document.getElementById("ogorod_sorts_chart_bar");
  var ogorod_sorts_chart_bar_chart;

  ogorod_sorts_chart_bar_chart = new Chart(ogorod_sorts_chart_bar_ctx, {
    type: 'horizontalBar',
    data: {
      datasets: [{
        data: [@foreach($ogorod_sorts_count_cultures as $count){{ $count }},@endforeach],
        backgroundColor: '#f39a24'
      }],
      labels: [@foreach($ogorod_sorts_count_cultures as $culture => $count)'{{ $culture }}',@endforeach]
    },
    options: {
      legend: {
        display: false
  ...
  /* Sad statistics */
  var sad_sorts_chart_bar_ctx = document.getElementById("sad_sorts_chart_bar");
  var sad_sorts_chart_bar_chart;

  sad_sorts_chart_bar_chart = new Chart(sad_sorts_chart_bar_ctx, {
    type: 'horizontalBar',
    data: {
      datasets: [{
        data: [@foreach($sad_sorts_count_cultures as $count){{ $count }},@endforeach],
        backgroundColor: '#179e36'
      }],
      labels: [@foreach($sad_sorts_count_cultures as $culture => $count)'{{ $culture }}',@endforeach]
    },
    options: {
      legend: {
        display: false
