  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Количество справочных статей в секции "Клумба"</span>
        <span class="info-box-number">{{ $klumba_handbooks_count }}</span>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="col-md-12">
    <div class="box">
      <div class="box-header with-border text-center">
        <h3 class="box-title">Соотношение справок по культурам</h3>
      </div>
      <div class="box-body">
        <div class="chart">
          <canvas id="klumba_handbooks_chart_bar" width="300" height="75"></canvas>
        </div>
      </div>
    </div>
  </div>
...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Количество справочных статей в секции "Огород"</span>
        <span class="info-box-number">{{ $ogorod_handbooks_count }}</span>
      </div>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-md-12">
    <div class="box">
      ...
      <div class="box-body">
        <div class="chart">
          <canvas id="ogorod_handbooks_chart_bar" width="300" height="75"></canvas>
        </div>
      </div>
    </div>
  </div>
...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="info-box">
      ...
      <div class="info-box-content">
        <span class="info-box-text">Количество справочных статей в секции "Сад"</span>
        <span class="info-box-number">{{ $sad_handbooks_count }}</span>
      </div>
    </div>
  </div>
</div>
...
<div class="row">
  <div class="col-md-12">
    <div class="box">
      ...
      <div class="box-body">
        <div class="chart">
          <canvas id="sad_handbooks_chart_bar" width="300" height="75"></canvas>
        </div>
      </div>
    </div>
  </div>
...
$(document).ready(function() {
  /* Klumba statistics */
  var klumba_handbooks_chart_bar_ctx = document.getElementById("klumba_handbooks_chart_bar");
  var klumba_handbooks_chart_bar_chart;

  klumba_handbooks_chart_bar_chart = new Chart(klumba_handbooks_chart_bar_ctx, {
    type: 'horizontalBar',
    data: {
      datasets: [{
        data: [@foreach($klumba_handbooks_count_cultures as $count){{ $count }},@endforeach],
        backgroundColor: '#a95f8a'
      }],
      labels: [@foreach($klumba_handbooks_count_cultures as $culture => $count)'{{ $culture }}',@endforeach]
    },
    options: {
      legend: {
        display: false
  ...
  /* Ogorod statistics */
  var ogorod_handbooks_chart_bar_ctx = document.getElementById("ogorod_handbooks_chart_bar");
  var ogorod_handbooks_chart_bar_chart;

  ogorod_handbooks_chart_bar_chart = new Chart(ogorod_handbooks_chart_bar_ctx, {
    type: 'horizontalBar',
    data: {
      datasets: [{
        data: [@foreach($ogorod_handbooks_count_cultures as $count){{ $count }},@endforeach],
        backgroundColor: '#f39a24'
      }],
      labels: [@foreach($ogorod_handbooks_count_cultures as $culture => $count)'{{ $culture }}',@endforeach]
    },
    options: {
      legend: {
        display: false
  ...
  /* Sad statistics */
  var sad_handbooks_chart_bar_ctx = document.getElementById("sad_handbooks_chart_bar");
  var sad_handbooks_chart_bar_chart;

  sad_handbooks_chart_bar_chart = new Chart(sad_handbooks_chart_bar_ctx, {
    type: 'horizontalBar',
    data: {
      datasets: [{
        data: [@foreach($sad_handbooks_count_cultures as $count){{ $count }},@endforeach],
        backgroundColor: '#179e36'
      }],
      labels: [@foreach($sad_handbooks_count_cultures as $culture => $count)'{{ $culture }}',@endforeach]
    },
    options: {
      legend: {
        display: false
